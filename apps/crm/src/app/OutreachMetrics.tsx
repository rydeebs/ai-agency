...
export function OutreachMetrics() {
  ...
  return <div className="mx-auto max-w-6xl">
    <PageHeader title="Outreach Metrics" subtitle="Compare subject and body variants using sends, replies, opens, and Gmail delivery failures." action={<Button type="button" disabled={scanning} onClick={() => void runBounceScan()}>{scanning ? "Checking Gmail…" : "Check Gmail now"}</Button>} />
